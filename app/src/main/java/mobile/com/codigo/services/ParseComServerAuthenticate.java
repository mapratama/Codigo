...
public class ParseComServerAuthenticate implements AuthenticatorService.ServerAuthenticate {
    ...
    public String userSignUp(String name, String email, String pass, String authType) throws Exception {
        ...
        String user = "{\"username\":\"" + email + "\",\"password\":\"" + pass + "\",\"phone\":\"123-456-789\"}";
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode() != 201) {
                ...
                throw new Exception("Sorry, " + error.error);
            }
